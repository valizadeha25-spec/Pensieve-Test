...
The scout practice itself kept running while the cycle sat parked: the 2026-08-31 run was the first routine scout after a 2.5-month gap, covering five clusters — AI-hype reality-check, solo-founder, build-in-public, non-technical founder, and honest-signal / practitioner takes — and filing its pattern findings as a dated wiki synthesis that cross-links the captured examples it draws on.^\[22\]^[^data:271] Its headline patterns — contradiction as the dominant hook formula across all clusters, and text-only dominance — are part of the platform-craft picture maintained on [LinkedIn](../../../content-brand/channels/linkedin/page.md).^\[23\]^[^data:271]^\[24\]^[^data:271] The run also measured the capture pipeline itself: harvestapi returned 44–50 posts per run at a 4/5 rating, while scarletapi returned zero posts across all five clusters, a systemic failure with a removal proposal filed in the main session.^\[25\]^[^data:271]^\[26\]^[^data:271]^\[27\]^[^data:271] Whether that removal was actioned remained an open question for the next scout run.^\[28\]^[^data:271]
