...
The hook guide treats the opening as a job-specific mechanism—curiosity, challenge, proof, surprise, pain diagnosis, comparison, or compressed authority—and requires the first line or frame to establish stakes without greetings, with the body clearing the expectation it creates.^\[35\]^ (`data:175`) The June scout identified counter-intuitive reframes, problem-first open questions, first-person narratives with concrete outcomes, vulnerability or friction, and evidence-first essays as recurring patterns.^\[36\]^ (`data:139`)
